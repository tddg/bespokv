...
run_clusteron hulk1 12345 aa1 aa-ev.json aa-d0 &
sleep 1
run_clusteron hulk1 12346 aa1 aa-ev.json aa-d1 &
sleep 1
run_clusteron hulk1 12347 aa1 aa-ev.json aa-d2 &
sleep 1

run_clusteron hulk2 12345 aa1 aa-ev.json aa-d0 &
sleep 1
run_clusteron hulk2 12346 aa1 aa-ev.json aa-d1 &
sleep 1
run_clusteron hulk2 12347 aa1 aa-ev.json aa-d2 &
sleep 1

run_clusteron hulk3 12345 aa1 aa-ev.json aa-d0 &
sleep 1
run_clusteron hulk3 12346 aa1 aa-ev.json aa-d1 &
sleep 1
run_clusteron hulk3 12347 aa1 aa-ev.json aa-d2 &
sleep 1

run_clusteron hulk4 12345 aa1 aa-ev.json aa-d0 &
sleep 1
run_clusteron hulk4 12346 aa1 aa-ev.json aa-d1 &
sleep 1
run_clusteron hulk4 12347 aa1 aa-ev.json aa-d2 &
sleep 1

run_clusteron hulk5 12345 aa1 aa-ev.json aa-d0 &
sleep 1
run_clusteron hulk5 12346 aa1 aa-ev.json aa-d1 &
sleep 1
run_clusteron hulk5 12347 aa1 aa-ev.json aa-d2 &
sleep 1
}
...
gen_conf 192.168.0.173 2181 192.168.0.173 9092 eventual cr aa 0 aa-ev.json hulk0
