...
class Fdevents{
	...
	public:
		...
		int event_wait(int timeout_ms=-1);  // yue added
		void set_proxy(NetworkServer *proxy);  // yue added
		long unsigned get_events_size();  // yue added
};
